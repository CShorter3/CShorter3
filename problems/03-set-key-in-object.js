...
Your job is to return the object adding the second parameter 
as a key using the third parameter as its value.
...
let ob1j = {}
console.log(setKeyInObject(ob1j, "apple", "yum")); // => {apple: "yum"}

let obj1 = {str: "hello"}
console.log(setKeyInObject(obj1, "num", 3)); // => {str: "hello", num: 3}

console.log(setKeyInObject(obj1, "cost", 5));
